...
# default descriptor-based, brute force matching with knn
kTrackerType = FeatureTrackerTypes.DES_BF
# default descriptor-based, FLANN-based matching
# kTrackerType = FeatureTrackerTypes.DES_FLANN
...
# added
    ...
    FAST_TFEAT = dict(num_features=kNumFeatures,
                      num_levels=4,
                      scale_factor=1.2,
                      detector_type=FeatureDetectorTypes.FAST,
                      descriptor_type=FeatureDescriptorTypes.TFEAT,
