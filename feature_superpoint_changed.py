...
class SuperPointOptions:
    def __init__(self, do_cuda=True):
        ...
        # self.weights_path = config.cfg.root_folder + '/thirdparty/eric-yyjau/pytorch-superpoint/logs/superpoint_kitti_heat2_0/checkpoints/superPointNet_50000_checkpoint.pth.tar'
        self.nms_dist = 4
