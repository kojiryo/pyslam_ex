...
class KeyFrame(Frame, KeyFrameGraph):
    ...
    def set_bad(self):
        # print('in Keyframe.set_bad case 0')
        with self._lock_connections:
            # print('in Keyframe.set_bad case 1')
            if self.kid == 0:
                # print('in Keyframe.set_bad case 2')
                return
            if self.not_to_erase:
                # print('in Keyframe.set_bad case 3')
                self.to_be_erased = True
                # print('in Keyframe.set_bad case 4')
                return
