...
class Trial(object):
    def __init__(self, work_dir_path, current_trial_count, ** tracker_config):
        self.config = Config()
        self.dataset = dataset_factory(self.config.dataset_settings)
        ...
        self.cam = PinholeCamera(self.config.cam_settings['Camera.width'], self.config.cam_settings['Camera.height'],
...
if __name__ == "__main__":
    ...
    for feature_name, tracker_config in pbar1:
        ...
        for current_trial_count in pbar2:
            ...
            # while True:
            trial = Trial(work_dir_path, current_trial_count, **tracker_config)
